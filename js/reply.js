    ...
    $("#additionalPersons").on('change', function () {
        ...
        if (persons > 0 ) {
            ...
            for (i = 0; i < persons; i++) {
                ...
                $("#extraPersons").append("<div class='col-sm-4'> <input type='name' required name='gjest_" + (i+2) + "' id = 'person" + (i + 2) + "'class='form-control' placeholder='Gjest " + (i + 2) + "'> </div>" +
                    " <div class='col-sm-4'><select class = 'form-control'  required name ='gjest_" + (i+2) + "_overnatting' id = '" + sleepoverid + "'>" +
                    "<option value = ''>-- Skal han/hun overnatte? --</option>" +
